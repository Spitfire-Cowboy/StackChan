...
private:
    ...
    static constexpr std::array<const char*, 9> _scene_json{{
        ...
        R"json({"id":"local-card-2","mode":"local","title":"LOCAL MODE","line":"Only 6+ base-point receipts extend the streak.","presentation_type":"card","visual_template":"status_card","emotion":"neutral","duration_ms":3200,"motion":{"yaw_angle":40,"pitch_angle":120,"speed":300},"led":{"r":20,"g":88,"b":32},"play_notification":false})json",
        ...
        R"json({"id":"global-card-2","mode":"global","title":"GLOBAL MODE","line":"The server re-checks the proof. Local scores are only hints.","presentation_type":"card","visual_template":"title_card","emotion":"neutral","duration_ms":3400,"motion":{"yaw_angle":-140,"pitch_angle":130,"speed":300},"led":{"r":0,"g":56,"b":112},"play_notification":false})json",
        ...
        R"json({"id":"party-card-2","mode":"party","title":"PARTY MODE","line":"Ranks break ties by streak first, then by join date.","presentation_type":"card","visual_template":"status_card","emotion":"neutral","duration_ms":3400,"motion":{"yaw_angle":120,"pitch_angle":90,"speed":300},"led":{"r":124,"g":52,"b":124},"play_notification":false})json",
    }};
